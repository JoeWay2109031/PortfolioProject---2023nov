...
-->
        ...
        <div name="header + main section" class="self-center flex w-full max-w-[1320px] flex-col items-stretch max-md:max-w-full">
            <div name="header" class="h-20 gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0 items-center justify-between sticky top-0">
                ...
                <div class="text-zinc-800 text-3xl font-comfortaa font-bold leading-[58px] flex-initial basis-auto">
                    Lauren Petersen
                </div>
                <div name="top nav bar" class="self-stretch flex items-center justify-self-end gap-5 max-md:max-w-full max-md:flex-wrap">
                    <div name="top nav bar left" class="items-stretch flex pt-0 pb-0 justify-between gap-4 my-auto max-md:justify-center">
                        <div class="hover:bg-slate-100 active:bg-slate-200 hover:cursor-pointer hover:text-purple-400 hover:border-b-purple-400 text-lg font-raleway font-medium leading-7 whitespace-nowrap items-stretch self-center aspect-[1.8571428571428572] my-auto rounded-sm border-b-2 border-b-black border-solid">
                            Home
                        </div>
                        <div class="bg-black w-px shrink-0 h-10"></div>
                        <div class="text-zinc-800 text-lg font-raleway font-medium leading-7 self-center my-auto">
                            Projects
                        </div>
                        <div class="bg-black w-px shrink-0 h-10"></div>
                        <div class="text-zinc-800 text-lg font-raleway font-medium leading-7 self-center whitespace-nowrap my-auto">
                            About
                        </div>
                    </div>
                    <div name="top nav bar right" class="text-white text-center text-xl font-outfit font-medium leading-6 tracking-widest capitalize whitespace-nowrap items-stretch self-stretch grow px-5 py-2.5 rounded-xl">
                        Contact Me
                    </div>
                </div>
                    <!-- </div> -->
        ...
        <div name="work experience section" class="justify-center items-center bg-slate-50 self-stretch flex w-full flex-col mt-14 pl-11 pr-11 pt-11 pb-24 max-md:max-w-full max-md:mt-10 max-md:px-5"
        >
            <div
                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                Malesuada pulvinar sapien at integer elit
                                non quam ut nec. Congue suspendisse arcu
                                massa ullamcorper amet proin orci risus.
                                Rhoncus netus volutpat suspendisse turpis
                                cras accumsan. Nibh integer viverra felis
                                magna varius etiam pretium quis ornare.
                                Morbi proin eget dolor volutpat sapien massa
                                mi. Iaculis dolor vitae sit sit nibh.
                                Dignissim at viverra molestie cras et
                                fermentum quis purus. Diam nec elit feugiat
                                euismod amet mi tristique commodo quam. Ac
                                nulla interdum facilisis praesent integer
                                rutrum tristique id feugiat. Ipsum sapien
                                leo eleifend fringilla nulla habitasse. Eget
                                aliquet odio imperdiet faucibus in enim.
                                Elementum dolor nisl sed felis etiam
                                scelerisque.
                                <br />
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                elementum ornare felis nec consequat.
                                Pulvinar urna pellentesque elit tincidunt
                                fames tortor. Magna et etiam pellentesque
                                fringilla sit nunc. Viverra massa vel
                                rhoncus tortor diam pulvinar. In nunc
                                porttitor volutpat vulputate non aliquam
                                enim. Diam pellentesque pharetra diam
                                porttitor malesuada ut sagittis.
                                <br />
                                Volutpat cursus donec ultricies aliquet
                                scelerisque quisque. Diam vitae in
                                scelerisque posuere viverra sit sit
                                ultricies gravida. Amet tempor tristique mi
                                donec. Morbi sed eu a ornare etiam morbi.
                                Luctus ut sapien ultrices non adipiscing
                                risus donec vulputate scelerisque. Nec
                                consequat nullam et sed. Nulla in.
                            </div>
                        </div>
                    </div>
                    <div
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                Lorem ipsum dolor sit amet consectetur.
                                Consectetur quis praesent consequat blandit
                                ornare diam libero sem. Tincidunt felis
                                adipiscing id at dictumst. Pellentesque enim
                                ornare pharetra felis mi tellus purus.
                                Elementum cum facilisis nunc feugiat semper
                                viverra sociis. Pellentesque netus
                                suspendisse sed eget dui est felis.
                                Pellentesque amet urna id id. Posuere
                                senectus vitae dui a semper est sed ornare
                                nunc. Viverra ipsum tristique erat
                                venenatis. Neque in velit odio condimentum
                                id urna mauris. Nam senectus bibendum nunc
                                cursus id diam nibh integer id. Imperdiet
                                scelerisque non at aliquam risus.
                                <br />
                                Risus lorem bibendum in proin faucibus id
                                sagittis. Molestie purus morbi ac eget
                                integer quisque ultrices et. Sociis vitae
        ...
        <div name="project heading" class="justify-center items-stretch self-center flex w-[181px] max-w-full flex-col mt-28 px-5 max-md:mt-10"
        >
            <div
            ...
            <div
                class="bg-purple-300 self-center flex w-[100px] shrink-0 h-1 flex-col mt-1 rounded-sm"
            ></div>
        </div>
        <div name="project 1" class="shadow-2xl self-center w-full max-w-[992px] mt-20 rounded-3xl max-md:max-w-full max-md:mt-10"
        >
            <div
                class="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0"
            >
        ...
        <div name="project 2" class="shadow-2xl self-center w-full max-w-[992px] mt-20 rounded-3xl max-md:max-w-full max-md:mt-10">
            <div
                class="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0"
            >
                <div
        ...
        <div name="project 3" class="shadow-2xl self-center w-full max-w-[992px] mt-20 rounded-3xl max-md:max-w-full max-md:mt-10">
            <div
                class="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0"
            >
                <div
                ...
                >
                    ...
                    >
                        ...
                        <div
                            class="font-nunito self-stretch text-zinc-500 text-lg leading-7 mt-6"
                        >
                            You can also add in this description the type of
                            the project, if it was for web, mobile,
                            electron.
                        </div>
                        <div
                            class="text-zinc-800 text-lg font-roboto font-medium leading-7 whitespace-nowrap items-center border border-[color:var(--font-high-emphasis,#25282B)] mb-0 w-[150px] max-w-full mt-6 px-5 py-2 rounded-3xl border-solid max-md:mb-2.5"
        ...
        <div name="contact heading" class="justify-center items-stretch self-center flex w-[173px] max-w-full flex-col mt-44 max-md:mt-10">
            ...
            <div
                class="ml-5 bg-purple-300 self-center flex w-[100px] shrink-0 h-1 flex-col mt-1 rounded-sm"
            ></div>
        </div>
        <div name="contact form + footer" class="justify-center items-center self-center z-[1] flex w-[650px] max-w-full flex-col mt-20 px-5 py-0.5 max-md:mt-10">
            <div class="items-stretch self-stretch flex flex-col -mr-5">
                <div
                    class="text-zinc-800 text-base font-nunito font-semibold leading-6 whitespace-nowrap"
                >
                    Name
                </div>
                <div
                    class="border bg-white flex shrink-0 h-10 flex-col mt-3.5 rounded-lg border-solid border-slate-200"
                ></div>
            </div>
            <div
                class="items-stretch self-stretch flex flex-col -mr-5 mt-7"
            >
                <div
                    class="text-zinc-800 text-base font-nunito font-semibold leading-6 whitespace-nowrap"
                >
            ...
            >
                ...
                <div
                    class="border bg-white flex shrink-0 h-40 flex-col mt-3 rounded-lg border-solid border-slate-200"
                ></div>
            </div>
            <!-- working send button CSS interaction, can reuse this -->
            <div
                class="text-zinc-800 hover:text-zinc-50 text-lg font-roboto font-medium leading-7 whitespace-nowrap items-center bg-purple-300 hover:bg-purple-400 active:bg-purple-500 hover:cursor-pointer w-[89px] max-w-full -mr-5 mt-4 px-4 py-2 rounded-lg self-end"
            >
                Send
            </div>

            <footer class="justify-center items-center flex flex-col">
                <div
                    name="footer_contact_icon_links"
                    class="justify-center items-start self-center flex w-[258px] max-w-full gap-4 mt-14 max-md:justify-center max-md:mt-10"
                >
                    <img
                        loading="lazy"
                        src="https://cdn.builder.io/api/v1/image/assets/TEMP/178ec17d-661f-4009-a352-b63ec271b3b2?"
                        class="aspect-square object-scale-down object-center w-full fill-black overflow-hidden shrink-0 flex-1 my-auto"
                    />
                    <img
                        loading="lazy"
                ...
                <pre class="font-poppins mt-5 text-zinc-500 text-base">
